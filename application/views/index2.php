		...
		<div class="col-sm-12">
			...
			<div class="row">
				<?php
					...
					function spewColumn($data) {
					?>
					<div class="col-md-4 col-sm-6">
						<?php
						
						//per artikel het volgende loopen:
						foreach ($data as $artikel) {
						?>
						<div class="panel panel-default">
							<div class="panel-heading-other" ><a href="#" class="pull-right">View all</a> <h4><?php echo $artikel['artikel_titel']; ?></h4></div>
							<div class="panel-body" >
								<?php
								
									//hier de artikel tekst loopen:
					...
					function spewRow($data, $row) {
						//make 3 new arrays
						//$column() = new array;
						foreach ($data as $key => $artikel) {
							if ($artikel['order'] == $row) {
								$column[] = $artikel;
							}
						}
						return $column;
					...
					//$column1 = new array();
					$column1 = spewRow($artikelen, 1);
					$column2 = spewRow($artikelen, 2);
					$column3 = spewRow($artikelen, 3);
